...
!===============================================================================
  ...
  subroutine hetfrz_classnuc_oslo_init(mincld_in)
    ...
    call addfld('bc_num_scaled',   (/ 'lev' /), 'A', '#/cm3', 'total bc number scaled by inp_mult')
    call addfld('dst1_num_scaled', (/ 'lev' /), 'A', '#/cm3', 'total dst1 number scaled by inp_mult')
    call addfld('dst3_num_scaled', (/ 'lev' /), 'A', '#/cm3', 'total dst3 number scaled by inp_mult')
