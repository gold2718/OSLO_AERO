...
subroutine radiation_tend( &
   ...
   real(r8) :: clearod440(pcols)
   real(r8) :: clearod550(pcols)
   real(r8) :: clearod870(pcols)
   real(r8) :: clearabs550(pcols)
   real(r8) :: clearabs550alt(pcols)
   ...
   if (dosw .or. dolw) then
      ...
      if (dosw) then
         ...
         call oslo_aero_optical_params_calc(lchnk, ncol, 10.0_r8*state%pint, state%pmid,  &
              ...
              aer_tau, aer_tau_w, aer_tau_w_g, aer_tau_w_f, aer_lw_abs, &
